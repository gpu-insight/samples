...
int main(int argc, char **argv) {
    ...
    {
       0xFF, 0x00, 0xEF, 0xFF, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0xEF, 0xFF, 0x00, 0x00, 0x00, 0xFF,
       0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0xEF, 0xFF, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0xEF, 0xFF,
       0xFF, 0x00, 0xEF, 0xFF, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0xEF, 0xFF, 0x00, 0x00, 0x00, 0xFF,
       0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0xEF, 0xFF, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0xEF, 0xFF,
    };
    ...
    GL_CHECK(glTexStorage2D(GL_TEXTURE_2D, 3, GL_RGBA8,  /* SIZED internal format */
                             4, 4));
    for (int level = 0; level < 3; level++)
    {
        GL_CHECK(glTexSubImage2D(GL_TEXTURE_2D, level,
                    0, 0, 4 >> level, 4 >> level,
